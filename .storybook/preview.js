...
const HawaCreateTheme = (
  ...
  createTheme({
    ...
    primaryLayoutColor: primaryLayoutColor,
    ...
    updateValue: (
      ...
      allBorderRadius = borderRadius;
      primaryActionColor = ActionColor;
      primaryLayoutColor = primaryLayoutColor;
      primaryActionTextColor = primaryActionTextColor;
      mainFont = mainFont;
    },
...
const theme = HawaCreateTheme(10, "#3b28cc", "#ADD7F6", "#ffffff", "Roboto");
