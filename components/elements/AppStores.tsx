  ...
  return (
    <div className="hawa-flex hawa-justify-center">
      <div>
        ...
        {props.store === "apple" ? (
          props.mode === "dark" ? (
            <div className="hawa-mt-3 hawa-flex hawa-h-14 hawa-w-48 hawa-items-center hawa-justify-center hawa-rounded-lg hawa-bg-black hawa-text-white">
            ...
            <div className="hawa-mt-3 hawa-flex hawa-h-14 hawa-w-48 hawa-items-center hawa-justify-center hawa-rounded-lg hawa-border hawa-border-black hawa-bg-transparent hawa-text-black">
              <div className="hawa-mr-3">
                <svg viewBox="0 0 384 512" width="30">
                  <path
                    fill="currentColor"
          ...
          <div className="hawa-mt-3 hawa-flex hawa-h-14 hawa-w-48 hawa-items-center hawa-justify-center hawa-rounded-lg hawa-border hawa-border-black hawa-bg-white hawa-text-black">
            <div className="hawa-mr-3">
              <svg viewBox="30 336.7 120.9 129.2" width="30">
                <path
                  fill="#FFD400"
