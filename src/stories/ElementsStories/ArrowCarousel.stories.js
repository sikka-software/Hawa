...
import { ArrowCarousel as AC } from "../../elements";

export default {
  title: "Elements/Arrow Carousel",
  component: AC,
  argTypes: {}
};
...
export const ArrowCarousel = Template.bind({});
ArrowCarousel.args = {
  items: [
    { label: "Afghanistan", icon: <AfghanistanFlag /> },
    { label: "Albania", icon: <AlbaniaFlag /> },
    { label: "Angola", icon: <AngolaFlag /> }
  ]
};
